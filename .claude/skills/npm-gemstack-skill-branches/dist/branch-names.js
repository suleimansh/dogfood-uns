...
export function agentIdFromWorktreeDir(name) {
 ...
 */
export function sessionNameOf(branch, agentId) {
    if (!branch || !isAgentBranch(branch) || (agentId !== undefined && branch === agentBranchName(agentId)))
        return undefined;
    return branch.slice(AGENT_BRANCH_PREFIX.length);
}
//# sourceMappingURL=branch-names.js.map